...
insert into default_vstream_config (id_group, config) VALUES ((select id_group from vstream_groups where group_name = 'default'), '{"blur": 300.0, "margin": 5.0, "blur-max": 13000.0, "tolerance": 0.5, "title-height-ratio": 0.033, "osd-datetime-format": "%Y-%m-%d %H:%M:%S", "logs-level": "info", "capture-timeout": "2s", "face-confidence": 0.7, "delay-after-error": "30s", "face-enlarge-scale": 1.5, "open-door-duration": "10s", "delay-between-frames": "1s", "face-class-confidence": 0.7, "dnn-fc-inference-server": "127.0.0.1:8000", "dnn-fd-inference-server": "127.0.0.1:8000", "dnn-fr-inference-server": "127.0.0.1:8000", "max-capture-error-count": 3, "best-quality-interval-after": "2s", "best-quality-interval-before": "5s", "workflow-timeout": "0s", "flag-spawned-descriptors": false, "unknown-descriptor-ttl": "5s", "flag-process-faces": true, "flag-process-barcodes": false}') on conflict do nothing;
